...
export function ChatInterfaceAlt({ onSplitView }: ChatInterfaceProps) {
  ...
  return (
    <div className="flex flex-col h-full bg-background">
      ...
      <div className="border-b border-border p-4">
        <h2 className="text-xl font-semibold text-foreground">부동산 챗봇 (채팅 내 큰 스피너)</h2>
              ...
              <Card className="p-6 bg-card border-2 border-dashed">
                <div className="flex flex-col items-center gap-4">
                  {processingAgent && getAgentSpinner(processingAgent) ? (
                    <video autoPlay loop muted className="w-16 h-16 object-cover rounded-lg">

...
class VectorDBService:
    ...
    def __init__(self):
        ...
        # Model paths
        self.embedding_model_path = Path(r"C:\kdy\Projects\holmesnyangz\beta_v001\backend\data\storage\kure_v1")
        self.reranker_model_path = Path(r"C:\kdy\Projects\holmesnyangz\beta_v001\backend\data\storage\bge-reranker-v2-m3-ko")
